...
const int16_t EEPROM_init2[MAX_PARA_NUMBER2 + 1][5]=
{
  ...
  {    60,     0, 10000,      1,      not_dot},   //Pr-37   num_heat_box_TDIS_high_delaytime   1分钟
  {    20, -1000,  1000,      1,      dot_0d1},   //Pr-38   num_prot2_TA_low_Tdelt
  {    60,     0, 10000,      1,      not_dot},   //Pr-39   num_heat_box_TDIS_low_delaytime    1分钟
  //----------------------------------------------------------------------------
  //  val    min    max   editrate   para_disprate
...
const int16_t EEPROM_init[MAX_PARA_NUMBER + 1][5]=
{
  ...
  //----------------------------------------------------------------------------
  //加温箱
  {   360, -1000,  1000,      1,      not_dot},   //Pr-23   num_user_set_TS
  {   400, -1000,  1000,      1,      not_dot},   //Pr-24   num_user_set_ALH
  {   300, -1000,  1000,      1,      not_dot},   //Pr-25   num_user_set_ALL
  {     2, -1000,  1000,      1,      not_dot},   //Pr-26   num_user_set_Lt
  ...
  {     0, -1000,  1000,      1,      not_dot},   //Pr-33   num_fac_Ct1
  {     0, -1000,  1000,      1,      not_dot},   //Pr-34   num_fac_Ct2
  {     0, -1000,  1000,      1,      not_dot},   //Pr-35   num_fac_Cd
  {     1, -1000,  1000,      1,      not_dot},   //Pr-36   num_fac_T1
  {     3, -1000,  1000,      1,      not_dot},   //Pr-37   num_fac_T2
  {     1, -1000,  1000,      1,      not_dot},   //Pr-38   num_fac_Fd  
};
//------------------------------------------------------------------------------
#endif
