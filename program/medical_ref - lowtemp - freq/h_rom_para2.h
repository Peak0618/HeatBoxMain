...
//------------------------------------------------------------------------------
//参数个数定义
#define   MAX_PARA_NUMBER2     160      //参数总数
//------------------------------------------------------------------------------
//参数编号定义
...
//----------------------------------------------------------
#define   num_comp2_run_Tdelt                     8
#define   num_comp2_stop_Tdelt                    9
#define   num_comp2_mode_T                        10
...
#define   num_heat_box_TDIS_high_delaytime             37
#define   num_prot2_TA_low_Tdelt                  38
#define   num_heat_box_TDIS_low_delaytime              39
...
///*
//血液相关
#define   num_blood_comp_t1_min                   142   //压缩机延时最小值
#define   num_blood_comp_t1_max                   143
#define   num_blood_comp_r0_min                   144   //温差控制最小值
#define   num_blood_comp_r0_max                   145
#define   num_blood_comp_r00_min                  146   //温差控制最小值
#define   num_blood_comp_r00_max                  147
#define   num_blood_comp_s1_min                   148
#define   num_blood_comp_s1_max                   149
#define   num_blood_comp_s2_min                   150
#define   num_blood_comp_s2_max                   151
//*/
...
//------------------------------------------------------------------------------
//参数个数定义
#define   MAX_PARA_NUMBER      75       //参数总数
//------------------------------------------------------------------------------
//参数编号定义
...
//加温箱
//用户参数
#define   num_user_set_TS                         23
#define   num_user_set_ALH                        24
#define   num_user_set_ALL                        25
#define   num_user_set_Lt                         26
#define   num_user_set_dA                         27
#define   num_user_set_S1                         28
#define   num_user_set_S2                         29
#define   num_user_set_TT                         30
//工厂参数
#define   num_fac_r0                              31
#define   num_fac_r1                              32
#define   num_fac_Ct1                             33
#define   num_fac_Ct2                             34
#define   num_fac_Cd                              35
#define   num_fac_T1                              36
#define   num_fac_T2                              37
#define   num_fac_Fd                              38
